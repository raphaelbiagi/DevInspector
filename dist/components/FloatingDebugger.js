...
export const FloatingDebugger = () => {
    ...
    const errorCount = history.filter(e => e.type === 'console:entry' && e.payload.level === 'error').length;
    useEffect(() => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Animated.View, { style: [
                ...
                ], ...panResponder.panHandlers, children: _jsxs(TouchableOpacity, { style: styles.touchable, onPress: () => setModalVisible(true), activeOpacity: 0.8, children: [_jsx(BugIcon, { color: "#3B82F6", size: 24 }), errorCount > 0 && (_jsx(View, { style: styles.badge, children: _jsx(Text, { style: styles.badgeText, children: errorCount > 9 ? '9+' : errorCount }) }))] }) }), _jsx(DebuggerModal, { visible: modalVisible, onClose: () => setModalVisible(false) })] }));
};
...
//# sourceMappingURL=FloatingDebugger.js.map